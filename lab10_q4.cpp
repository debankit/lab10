...
rectangle::rectangle(Point lower,Point upper)//getting the lower and upper ponint and seeting it in our rectangles point
{
  A=lower;
  C=upper;
  B.Set_X(upper.Get_X());
...
// Moving point p2 by (1, -1):
  ...
  cout<< "The x value for p2 is " << p2.Get_X() << endl;
  cout<< "The y value for p2 is " << p2.Get_Y() << endl;
//Lab 7 Exercises 4.2, 4.3. Testing of the class Rectangle 
    int x1,x2,y1,y2;
